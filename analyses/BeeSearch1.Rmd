...
dat_ridges <- dat.ex.msp %>% 
  filter(Genus != "Diadasia" & Genus != "Anthophora") %>% 
  droplevels() %>% 
...
dat_ridges %>% 
  ...
  annotate(geom = "text", x = 7, y = 25, label = "Winter") +
  annotate(geom = "text", x = 20, y = 25, label = "Spring") +
  annotate(geom = "text", x = 32, y = 25, label = "Summer") +
  annotate(geom = "text", x = 43, y = 25, label = "Fall") 
