...
genus.props.pos <- dat1 %>% 
  filter(Site == "POS" & Collection.Method == "T") %>% 
  group_by(Genus) %>% 
  tally(name = "Prop") %>% 
  mutate(prop.abund = Prop/nrow(filter(dat1, Site == "POS" &
                                         Collection.Method == "T")))
...
genus.props.scl <- dat1 %>% 
  filter(Site == "SCL" &
           Collection.Method == "T") %>% 
  group_by(Genus) %>% 
  tally(name = "Prop") %>% 
  mutate(prop.abund = Prop/nrow(filter(dat1, Site == "SCL" &
                                         Collection.Method == "T")))
...
genus.props.bpf <- dat1 %>% 
  filter(Site == "BPF" & 
           Collection.Method == "T") %>% 
  group_by(Genus) %>% 
  tally(name = "Prop") %>% 
  mutate(prop.abund = Prop/nrow(filter(dat1, Site == "BPF" &
                                         Collection.Method == "T")))
